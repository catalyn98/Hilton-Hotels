...
<body>
    ...
    <section id="services">
        ...
        <div>
            <a href="#vacations"><img class="bring-to-front" src="./Images/OROS ANDREI.png" alt="OROS ANDREI" /></a>
            <h3 class="sml-h3">OROS ANDREI</h3>
            <p class="sml-p">President & Chief Executive Officer, Global Development</p>
        </div>
        <div id="flights-ser">
            <a href="#flights"><img class="bring-to-front" src="./Images/VIVIEN MUNTEANU.png" alt="VIVIEN MUNTEANU" /></a>
            <h3 class="sml-h3">VIVIEN MUNTEANU</h3>
            <p class="sml-p">Chief Financial Officer & President, Global Development</p>
        </div>
        <div>
            <a href="#hotels"><img class="bring-to-front" src="./Images/MIHALCA BOGDAN.png" alt="MIHALCA BOGDAN" /></a>
            <h3 class="sml-h3">MIHALCA BOGDAN</h3>
